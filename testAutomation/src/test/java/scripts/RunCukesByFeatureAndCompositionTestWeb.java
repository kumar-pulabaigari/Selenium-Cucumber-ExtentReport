...
@CucumberOptions(features = "src/com/features/googleScenarios.feature", plugin = "json:target/cucumber2.json")
public class RunCukesByFeatureAndCompositionTestWeb extends WebDriverTestCase {
